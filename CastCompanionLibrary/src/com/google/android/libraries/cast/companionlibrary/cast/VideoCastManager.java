...
public class VideoCastManager extends BaseCastManager
     ...
     * (non-Javadoc)
     * @see com.google.android.libraries.cast.companionlibrary.widgets.MiniController.
     * OnMiniControllerChangedListener#onStopClicked(android.view.View)
     * @throws TransientNetworkDisconnectionException
     * @throws NoConnectionException
     * @throws CastException
     */
    @Override
    public void onStopClicked(View v) throws CastException, TransientNetworkDisconnectionException, NoConnectionException {
        checkConnectivity();
        /*
        if (mState == MediaStatus.PLAYER_STATE_PLAYING) {
            stop();
    ...
    public void loadMedia(MediaInfo media, boolean autoPlay, int position, int countTracks, int positionTrack)
            throws TransientNetworkDisconnectionException, NoConnectionException {
        mCountTracks = countTracks;
    ...
    public void loadMedia(MediaInfo media, final long[] activeTracks, boolean autoPlay,
                          int position, JSONObject customData, int countTracks, int positionTrack)
            throws TransientNetworkDisconnectionException, NoConnectionException {
        LOGD(TAG, "loadMedia");
    ...
    private void updateMediaSessionMetadata() {
        ...
        try {
            ...
            MediaMetadataCompat.Builder newBuilder = currentMetadata == null
                    ? new MediaMetadataCompat.Builder()
                    : new MediaMetadataCompat.Builder(currentMetadata);
            MediaMetadataCompat.Builder builder = newBuilder
            ...
            if (iconUri == null) {
                ...
                newBuilder.putBitmap(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON, bm);
                /*
                mMediaSessionCompat.setMetadata(newBuilder
