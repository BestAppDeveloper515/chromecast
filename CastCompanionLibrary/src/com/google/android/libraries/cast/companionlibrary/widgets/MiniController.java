...
public class MiniController extends RelativeLayout implements IMiniController {
    ...
    protected ImageView mClosedCaption;
    ...
    private void setUpCallbacks() {
        ...
        mClosedCaption.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
                    Log.d("MiniController", "onClick: Closed Caption in Mini Controller");
                    try {
                        showTracksChooserDialog();
                    } catch (TransientNetworkDisconnectionException | NoConnectionException e) {
                        Log.e(TAG, "Failed to get the media", e);
                    }
                }
            }
        });
    ...
    private void showTracksChooserDialog()
        ...
        Fragment prev = mFragmentManager.findFragmentByTag(DIALOG_TAG);
        if (prev != null) {
    ...
    private void loadViews() {
        ...
        mStop = (ImageView) findViewById(R.id.stop_mini_controller);
        mClosedCaption = (ImageView) findViewById(R.id.closed_caption_mini_controller);
    ...
    public interface OnMiniControllerChangedListener extends OnFailedListener {
        ...
        /**
         * Notification that user has clicked on the Stop button in Mini Controller
         *
         * @throws TransientNetworkDisconnectionException
         * @throws NoConnectionException
         * @throws CastException
         */
        void onStopClicked(View v) throws CastException,
                TransientNetworkDisconnectionException, NoConnectionException;
