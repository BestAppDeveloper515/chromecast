...
public class SubtitlesAdapter extends RecyclerView.Adapter<SubtitlesAdapter.MyViewHolder> {

    private Context mContext;
    private File[] mObjects; //The List of objects we got from our model.

    private File mCurrentDir = null; //Our current location.
    private File mPreviousDir = null; //Our previous location.
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        SubtitlesAdapter foldersAdapter;

        public MyViewHolder(View view, SubtitlesAdapter foldersAdapter) {
            super(view);
    ...
    public SubtitlesAdapter(Context context, File currentDir) {
    ...
    private void castVideo(int id) {
        ...
        String ipdevice;
        String mimeType = getMimeType(serverFile.getName());
        if (mimeType == null) {
            mimeType = "video/mp4";
        }
            ...
            for (File file : allFiles) {
                if (file != null) {
                    if (file.isDirectory() && !file.getName().equals("")) {
                        ...
                        final String[] okFileExtensions = new String[]{"srt", "vtt"};
                        if (file.getName().toLowerCase().endsWith(okFileExtensions[0]) || file.getName().toLowerCase().endsWith(okFileExtensions[1])) {
                            files.add(file);
                        }
                    }
                }
